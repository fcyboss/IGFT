...
cwd = os.getcwd()
zpeng_colbert_path = join(cwd, "model_part", "retriever", "col_bert")
...
def main():
    ...
    parser.add_argument('--chunksize', dest='chunksize', default=60.0, required=False, type=float)   # in GiBs
    ...
    with Run.context():
        ...
        encoder = CollectionEncoder(args, process_idx=process_idx, num_processes=args.nranks) # encode the text here
        encoder.encode()
