...
from colbert.modeling.lossnet import LossNet
def train(args):
    random.seed(12345)
    ...
    colbert = ColBERT.from_pretrained('/individual/tongzhenyu/model/bert-base-uncased', #'bert-base-uncased',
    ...
    # torch.save(lossnet,'lossnet.pth')
