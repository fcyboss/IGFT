...
from colbert.modeling.inference_ast import ASTModelInference
# from colbert.evaluation.loaders import load_colbert
from colbert.utils.utils import print_message
from colbert.modeling.colbert import ASTColBERT
...
def load_colbert(args, do_print=True):
    colbert = ASTColBERT.from_pretrained('/individual/tongzhenyu/model/bert-base-uncased',#'bert-base-uncased',
...
class CollectionEncoder():
    ...
    def _load_model(self):
        self.colbert, _ = load_colbert(self.args, do_print=(self.process_idx == 0))
        self.colbert = self.colbert.cuda()
        self.colbert.eval()

        self.inference = ASTModelInference(self.colbert, amp=self.args.amp)
