...
Usage: python model_part/filter/bm25anserini_split.py
"""
...
data_part_dir = "/home/vn55kb9/proj/LLMsAgumentedIR/data_part/data"
...
#
gen_file_dir = join(data_part_dir, f"{args.dataset_name}_{args.train_num}", "100k")
